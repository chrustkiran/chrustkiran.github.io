...
$db2 = mysqli_query($conn , "SELECT * from examinfo where class='$cl'") or die("can't connect");
if(mysqli_num_rows($db2)==0){
$db = mysqli_query($conn , "INSERT into examinfo (class , term1,term2,term3) values ('$cl','$t1','$t2','$t3')");
}
else{
	mysqli_query($conn,"UPDATE examinfo SET term1 = '$t1',term2 = '$t2' , term3='$t3' where class = '$cl' ");
	echo "updated";
}
header('location:aexam.php');
}
