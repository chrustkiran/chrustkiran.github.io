...
<div class="container">
  ...
  <a href="ptimetable.php">Time Table</a>
  <div class="dropdown">
    <button class="dropbtn">Details</button>
    <div class="dropdown-content">
      <a href="pattend.php">Attendance</a>
      <a href="pclub.php">Club</a>
      <a href="pschool.php">School</a>
      <a href=pclass.php>Class</a>
    </div>
  </div> 
  <a href="pexam.php">Exam</a>
  <a href="pstuup.php">Update</a>

<div class="right">
<a href="pacc.php">Accounts</a>
