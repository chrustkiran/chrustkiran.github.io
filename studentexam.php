...
$x = "<table name=exta >
   ...
   // echo $x;
    ...
    $st = mysqli_real_escape_string($conn,$x);
    ?>
    <!DOCTYPE html>
    <html>
    <head>
    ...
    <div  id='HTMLtoPDF'>
    <h1>Mark sheet of <?php echo $id; ?> </h1>
        <?php echo $x; ?>
    </div>
    
    
        <a href="#" onclick="pdfToHTML()">Download as a PDF</a>
    </body>
    </html>
 <style type="text/css">
     table {
...
<table>
    ...
    <tr>
    	<td id="term11">first</td>
    	<td id="term22">second</td>
    	<td id="term33">third</td>
    </tr>
    </table>
</body>
</html>-->
