...
$dbuser = mysqli_query($conn , "SELECT * from exam where username = '$user'");
...
for($x=0; $x<count($exam[$cn-1]); $x++){
                    ...
                    if($t1a[$exam[$cn-1][$x]]==''){
                        $tab =$tab. "<td><input type=text name=(term1".$exam[$cn-1][$x].") placeholder=".$exam[$cn-1][$x]."></td>";
                    }
                    else{
                        $tab =$tab. "<td><input type=text name=(term1".$exam[$cn-1][$x].") placeholder=".$exam[$cn-1][$x]."=".$t1a[$exam[$cn-1][$x]]." value=".$t1a[$exam[$cn-1][$x]]."></td>";
                        //$total1 = $total1 + $t1a[$exam[$cn-1][$x]];
                    }
                    if($t2a[$exam[$cn-1][$x]]==''){
                        $tab =$tab. "<td><input type=text name=(term2".$exam[$cn-1][$x].") placeholder=".$exam[$cn-1][$x]."></td>";
                    }
                    else{
                         $tab =$tab. "<td><input type=text name=(term2".$exam[$cn-1][$x].") placeholder=".$exam[$cn-1][$x]."=".$t2a[$exam[$cn-1][$x]]." value=".$t2a[$exam[$cn-1][$x]]."></td>";
                         //$total2 = $total2 + $t2a[$exam[$cn-1][$x]];
                    }
                    if($t3a[$exam[$cn-1][$x]]==''){
                        $tab =$tab. "<td><input type=text name=(term3".$exam[$cn-1][$x].") placeholder=".$exam[$cn-1][$x]."></td>";
                    }
                    else{
                         $tab =$tab. "<td><input type=text name=(term3".$exam[$cn-1][$x].") placeholder=".$exam[$cn-1][$x]."=".$t3a[$exam[$cn-1][$x]]." value=".$t3a[$exam[$cn-1][$x]]."></td>";
